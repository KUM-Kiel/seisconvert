...
build/sdread: build/objects/sdread.o build/libseisconvert.a build/libtai.a Makefile
	@echo [LD] build/sdread
	@mkdir -p build/
	@$(LINK) -o build/sdread build/objects/sdread.o -lseisconvert -ltai
...
build/objects/kumy2wav.o: src/kumy2wav.c src/seisconvert/kumy_file.h src/seisconvert/kumy.h src/seisconvert/wav_file.h src/seisconvert/wav.h src/tai/taia.h src/tai/tai.h src/tai/caltime.h src/tai/caldate.h src/seisconvert/number.h src/seisconvert/byte.h Makefile
...
build/objects/sdread.o: src/sdread.c src/seisconvert/kumy_file.h src/seisconvert/kumy.h src/seisconvert/number.h src/tai/taia.h src/tai/tai.h src/tai/caltime.h src/tai/caldate.h src/seisconvert/byte.h Makefile
