...
build/objects/tai/caltime_scan.o: src/tai/caltime_scan.c src/tai/caltime.h src/tai/caldate.h Makefile
...
build/objects/tai/leapsecs_init.o: src/tai/leapsecs_init.c src/tai/leapsecs.h Makefile
